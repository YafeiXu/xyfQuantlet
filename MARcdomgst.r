#####----- 
mgst=function(theta1Input,theta2Input,weightInput,M,dateInput){
...
#norm.cop <- normalCopula(theta1Input, dim = 125, dispstr = "ex") # 用copula抽取随机数
...
U=t(rbind(rCopula(rN, norm.cop),rCopula(M-rN, t.cop))[sample(M,M,replace=FALSE),])
