#####----- 
ng16=function(theta1Input,theta2Input,theta3Input,M,dateInput){
#vNestedGumbelTrancheFig5(.1,.2,.3,10,c("2008/4/4"))
if(theta1Input<=theta2Input & theta2Input<=theta3Input){
#theta1Input=.15
#theta2Input=.08
#weightInput=.03
#MInput=100
...
copG <-onacopulaL("Gumbel",list(theta[1],NULL,list(
list(theta[2],126,list(list(theta[3],1:30))),
list(theta[2],127,list(list(theta[3],31:55))),              
list(theta[2],128,list(list(theta[3],56:75))),
list(theta[2],129,list(list(theta[3],76:95))),
list(theta[2],130,list(list(theta[3],96:115))),
list(theta[2],131,list(list(theta[3],116:125))) 
)))
rNCop <- rCopula(M, copG) 
...
#---19) return value
               if(trancheSpread1<0){return(c(NA,NA,NA,NA,NA))
               }else{
