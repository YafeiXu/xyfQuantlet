#####----- 
ng15=function(theta1Input,theta2Input,M,dateInput){
#vNestedGumbelTrancheFig4(.1,.3,10,c("2008/4/4"))
if(theta1Input<=theta2Input){
#theta1Input=.15
#theta3Input=.08
#weightInput=.03
#MInput=100
...
list(theta[2],c(1:30,126)),
list(theta[2],c(31:55,127)),
list(theta[2],c(56:75,128)),
list(theta[2],c(76:95,129)),
list(theta[2],c(96:115,130)),
list(theta[2],c(116:125,131))
