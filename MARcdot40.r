t40=function(theta1Input,theta2Input,dF,M,dateInput){
#vTTrancheF10(1/15,1/16,13,10,c("2008/4/4"))
...
vsigma=matrix(rho2,126,126)+(1-rho2)*diag(126)
vsigma[126,]=c(seq(rho1,rho1,length.out=125),1)
vsigma[,126]=c(seq(rho1,rho1,length.out=125),1)
