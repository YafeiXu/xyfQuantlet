#####----- 
mgg=function(theta1Input,theta2Input,weightInput,M,dateInput){
...
gumbel.cop1 <- gumbelCopula(iTau(gumbelCopula(), theta1Input), dim = d)

gumbel.cop2 <- gumbelCopula(iTau(gumbelCopula(), theta2Input), dim = d)
...
U=t(rbind(rCopula(rN, gumbel.cop1),rCopula(M-rN,gumbel.cop2))[sample(M,M,replace=FALSE),])
