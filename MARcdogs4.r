gs4=function(theta1Input,theta2Input,M,dateInput){
#vNestedGaussianTrancheFormula11(-1/13,-1/15,10,c("2008/4/4"))
...
################################################### formula 11 nested gaussian
#library(mvtnorm)
rho1=theta1Input
rho2=theta2Input
s1=matrix(rho2,31,31)+(1-rho2)*diag(31)
s2=matrix(rho2,26,26)+(1-rho2)*diag(26)
s3=matrix(rho2,21,21)+(1-rho2)*diag(21)
s4=matrix(rho2,21,21)+(1-rho2)*diag(21)
s5=matrix(rho2,21,21)+(1-rho2)*diag(21)
s6=matrix(rho2,11,11)+(1-rho2)*diag(11)
...
#rNCop=pnorm(rmvnorm(M, mean = rep(0, 131), sigma = vsigma,method="chol"))
